...
3. **[Customer Payment Method](SQL/revenue_ananlysis2.sql)**: Calculates the average ticket price based on payment methods.
4. **[Customer Purchase type](SQL/revenue_ananlysis2.sql)**: Calculates the average ticket price based on payment methods.
5. 
6. 
