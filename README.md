...
#### Revenue Analysis
* **[Revenue Generated by Route](SQL/revenue_analysis.sql)**: Calculates the average ticket price for each route.
* **[Revenue Generated by Payment Method](SQL/revenue_analysis.sql)**: Calculates the average ticket price based on payment methods.
* **[Customer Payment Method](SQL/revenue_ananlysis2.sql)**: Calculates the average ticket price based on payment methods.
